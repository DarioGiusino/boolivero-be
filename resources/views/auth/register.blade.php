              ...
              <div class="mb-4 row">
                ...
                <div class="col-md-6">
                  <input id="name" type="text" class="form-control @error('name') is-invalid @enderror"
                    name="name" value="{{ old('name') }}" required autocomplete="name" autofocus placeholder="Inserisci nome utente">
              ...
              <div class="mb-4 row">
                ...
                <div class="col-md-6">
                  <input id="email" type="email" class="form-control @error('email') is-invalid @enderror"
                    name="email" value="{{ old('email') }}" required autocomplete="email" placeholder="Inserisci email">
                  ...
                  <div class="mb-4 row">
                    ...
                    <div class="col-md-6">
                      <input id="address" type="text" class="form-control @error('address') is-invalid @enderror"
                        name="address" value="{{ old('address') }}" required autocomplete="address" autofocus placeholder="Inserisci indirizzo ristorante">
                  ...
                  <div class="mb-4 row">
                    ...
                    <div class="col-md-6">
                      <input id="vote" type="number" min= "1" max = "5" step="0.1" class="form-control @error('vote') is-invalid @enderror"
                        name="vote" value="{{ old('vote') }}" required autocomplete="vote" autofocus placeholder="Inserisci voto">
