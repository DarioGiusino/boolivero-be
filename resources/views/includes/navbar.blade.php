      ...
      <div class="row align-items-center">
          ...
          <div class="col-2 col-sm-4 col-md-3 col-lg-5 col-xl-6">
            <a class="navbar-brand d-flex align-items-center" href="{{ url('/admin') }}">
              <div class="logo m-0">
                      <img src="https://media.discordapp.net/attachments/1090194914433839158/1092735923176882276/Logo-BOOLIVEROO-WHITE.png?width=1440&height=490" alt="logo-deliveroo" class="img-fluid">
              </div>
            </a>  
          </div>
              ...
              <ul class="row text-end mb-0">
                      ...
                      <div class="partner-with-us">
                          <div class="dropdown">
                              <button class="btn nav-but" href="#" role="button" data-bs-toggle="dropdown"
                                  ...
                                  <span style="font-size:0.75rem;"><i
                                          class="lg fa-solid fa-chevron-down"></i>Partner with us</span>
                              </button>
                  ...
                  <li class="d-none d-sm-block col-sm-3 col-md-2">
                      <button class="btn nav-but" aria-current="page" href="#">
                          <span style="font-size:0.63rem;"><i
                                  class="lg fa-solid fa-cart-shopping"></i>$0.00</span>
                      </button>
                  </li>
                      ...
                      <div class="offcanvas offcanvas-end" tabindex="-1" id="offcanvasRight"
                          ...
                          <div class="offcanvas-header ">
                              ...
                              <div class="logo d-flex align-items-center">
                                  <img src="https://media.discordapp.net/attachments/1090194914433839158/1092736001354518528/Logo-COLORATO-BOOLEVEROO-.png?width=1440&height=490" alt="logo-deliveroo"
                                      class="img-fluid ">
